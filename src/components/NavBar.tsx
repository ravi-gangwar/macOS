  ...
  return (
    <nav className='nav'>
        <div className="nav-left">
            ...
            >
                ...
                <AppleMenu 
                  ...
                  onRestart={() => {
                    // This will be handled by ShutdownManager via event
                  }}
                  onLock={() => {
                    // Dispatch lock event
        ...
        <div className="nav-center">
            <p className={`nav-center-text ${getTextSize('sm')} font-normal text-gray-800 dark:text-gray-200`}>
              Ravi Gangwar
            </p>
        </div>
